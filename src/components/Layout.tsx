  ...
  return (
    <div className="flex flex-col min-h-screen bg-slate-50 dark:bg-slate-950 text-slate-900 dark:text-slate-50 transition-colors duration-300">
      ...
      <main className={cn(
        ...
        isVisible ? "pb-16 md:pb-0 md:pl-20 lg:pl-64" : "pb-0 md:pl-0 lg:pl-0"
      )}>
        {children}
      </main>
      ...
      <AnimatePresence>
        {isVisible && (
          <motion.aside 
            ...
            animate={{ x: 0 }}
            exit={{ x: -300 }}
            className="hidden md:flex flex-col fixed top-0 left-0 h-screen w-20 lg:w-64 bg-white dark:bg-slate-900 border-r border-slate-200 dark:border-slate-800 z-[999]"
          >
